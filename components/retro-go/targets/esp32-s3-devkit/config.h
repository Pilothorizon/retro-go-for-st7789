...
// Storage — SD_MMC (your setup)
#define RG_STORAGE_ROOT             "/sd"
#define RG_STORAGE_SDMMC_HOST       SDMMC_HOST_SLOT_1
#define RG_STORAGE_SDMMC_SPEED      SDMMC_FREQ_DEFAULT
// SD_MMC pins: CLK=39, CMD=38, D0=40 (set in sdmmc driver, not here)

// Audio — I2S external DAC (PCM5102A wired to whatever pins you use)
// Set these to your actual I2S pins when speaker is connected
#define RG_AUDIO_USE_INT_DAC        0
#define RG_AUDIO_USE_EXT_DAC        1

// Video
#define RG_SCREEN_DRIVER            0   // 0 = ILI9341/ST7789 — works for your 2.4" ST7789
...
// ST7789 init sequence (use this for your display)
...
// GPIO — SPI display (your exact pins)
...
#define RG_GPIO_LCD_BCKL            GPIO_NUM_NC  // wire backlight to 3.3V or a free pin

// I2S DAC pins — adjust to what you actually solder
